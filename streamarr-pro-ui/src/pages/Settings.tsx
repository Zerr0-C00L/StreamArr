        ...
        {activeTab === 'system' && (
          <div className="space-y-6">
            <div className="bg-[#1e1e1e] rounded-xl p-6 border border-white/10">
              ...
              {(installingUpdate || updateStatus) && (
                <div className="bg-blue-900/30 border border-blue-700 rounded-lg p-4 mb-6">
                  <h4 className="text-blue-300 font-medium mb-3 flex items-center gap-2">
                    <Activity className="h-5 w-5" /> Update Status
                  </h4>
                  {updateStatus && (
                    <div className="space-y-2 text-sm text-slate-300">
                      ...
                      {updateStatus.log_tail && (
                        <div className="mt-3 p-2 bg-gray-900/50 rounded text-xs font-mono max-h-40 overflow-y-auto">
                          {updateStatus.log_tail}
                        </div>
                      )}
                    </div>
                  ...
                  <button
                    onClick={checkUpdateLog}
                    className="mt-3 px-3 py-2 bg-blue-700 text-white rounded text-sm hover:bg-blue-600"
                  >
                    View Full Log
                  </button>
                </div>
              ...
              {/* Update Log Modal */}
              {showUpdateLog && updateStatus?.full_log && (
                <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
                  <div className="bg-gray-900 rounded-lg max-w-2xl max-h-96 flex flex-col">
                    <div className="flex justify-between items-center p-4 border-b border-gray-700">
                      <h3 className="text-white font-medium">Update Log</h3>
                      <button
